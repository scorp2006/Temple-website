...
export function Footer() {
  return (
    <footer className="bg-footer-bg text-footer-ink dark:bg-night-950 dark:text-parchment">
      ...
      <div
        aria-hidden
        className="block w-full overflow-hidden opacity-[0.4] dark:opacity-50 dark:[filter:brightness(0)_invert(1)_sepia(1)_saturate(320%)_hue-rotate(2deg)]"
        style={{ height: '42px' }}
      >
        <div
      ...
      <div className="mx-auto w-full max-w-[1600px] px-4 sm:px-6 lg:px-10 xl:px-14">
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-9 py-12 sm:grid-cols-3 lg:grid-cols-6">
          {columns.map((col) => (
            <div key={col.title}>
              <h4 className="font-serif text-[15px] font-bold text-footer-red dark:gold-text">{col.title}</h4>
        ...
        {/* contact row */}
        <div className="grid gap-5 border-t border-footer-ink/10 dark:border-parchment/10 py-7 text-sm sm:grid-cols-3">
          <p className="flex items-start gap-2.5">
            <MapPin className="mt-0.5 h-4 w-4 shrink-0 text-footer-red dark:text-sacredgold" />
            <span className="text-footer-ink/85 dark:text-parchment/80">
              Sri Jagajjanani Ammavaru Devasthanam,<br />
              Sri Durga Friends Unit, Sri Jagajjanani Nagar, Kurnool, Nandyala, AP – 518501
            </span>
          </p>
          <div className="space-y-2 text-footer-ink/85 dark:text-parchment/80">
            <span className="flex items-center gap-2.5"><Mail className="h-4 w-4 text-footer-red dark:text-sacredgold" /> srijagajjananitemple@gmail.com</span>
            <span className="flex items-center gap-2.5"><Globe2 className="h-4 w-4 text-footer-red dark:text-sacredgold" /> www.srijagajjananitemple.org</span>
          </div>
          <div className="space-y-2 text-footer-ink/85 dark:text-parchment/80">
            <span className="flex items-center gap-2.5"><Phone className="h-4 w-4 text-footer-red dark:text-sacredgold" /> +91 99867 27123</span>
            <span className="flex items-center gap-2.5"><Phone className="h-4 w-4 text-footer-red dark:text-sacredgold" /> +91 99633 64670</span>
          </div>
        </div>

        {/* visitor counters */}
        <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-3 border-t border-footer-ink/10 dark:border-parchment/10 py-5 text-sm text-footer-ink/85 dark:text-parchment/80">
          <span className="flex items-center gap-2">Total Visitors <b className="rounded bg-footer-red px-2.5 py-0.5 font-semibold text-white dark:gold-fill">1,00,000</b></span>
          <span className="flex items-center gap-2">Today&apos;s Visitors <b className="rounded bg-footer-red px-2.5 py-0.5 font-semibold text-white dark:gold-fill">72</b></span>
        </div>
      </div>
      ...
      <div className="border-t border-footer-ink/10 dark:border-parchment/10">
        <div className="mx-auto flex w-full max-w-[1600px] flex-col items-center justify-between gap-3 px-4 py-5 text-xs text-footer-ink/70 dark:text-parchment/65 sm:flex-row sm:px-6 lg:px-10 xl:px-14">
          <div className="flex gap-4 text-footer-ink/80 dark:text-parchment/70">
            ...
            <Link href="#" aria-label="Twitter"><Twitter className="h-5 w-5 transition-colors hover:text-footer-red dark:hover:text-sacredgold-light" /></Link>
          </div>
          <p className="text-center">© 2022 Jagajjanani Devasthanam · Privacy Policy · Terms &amp; Conditions</p>
          <p className="text-footer-ink/60 dark:text-parchment/55">Developed by AJS Innovations</p>
        </div>
      </div>
    </footer>
  );
